...
<div class="container p-5 my-5 bg-dark text-white">
	...
	<form method = "post" action="deleteSerMan">
    ...
    <div class="mb-3">
        ...
        <input type="text" name="branch" class="form-control" id="branch" value="<%=branch%>" readonly>
    </div>
    ...
    <div class="mb-3">
        ...
        <input type="text" name="startdate" class="form-control" id="date" value="<%=startdate%>" readonly>
    </div>
